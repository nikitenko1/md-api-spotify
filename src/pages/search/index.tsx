            ...
            <div className="space-y-8 w-full">
              ...
              <div className="flex flex-col md:flex-row gap-y-4 gap-x-4 w-full mt-4">
                <div className="flex-[0.4]">
                  <h1 className="text-white text-base md:text-2xl font-bold mb-4">Top results</h1>
                      ...
                      >
                        <Card key={v4()} large={true}>
                          <Image
                            ...
                            alt="album"
                          />
                          <p className="text-2xl md:text-4xl text-white font-bold ">{track.name}</p>
                          <div className="flex items-center gap-x-4">
                            <Link href={`/artist/${track.artists[0].id}`}>
                              <p
                                className="text-zinc-500 text-sm md:text-base font-semibold truncate 
                            border-[#1DB954] hover:border-b-2"
                              >
                ...
                <div className="flex-[0.6]">
                  ...
                  <div
                    className="border p-2 rounded-lg h-96 overflow-y-scroll  scrollbar-thumb-zinc-800
              ...
              <PlaylistsSearch title="Playlists" playlists={searchResult?.playlists?.items} />
